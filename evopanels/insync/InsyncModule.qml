...
Item {
    ...
    readonly property string cacheKey: "evo.panels.insync"
    readonly property string accountCachePath: Util.cachePath(Quickshell.env("HOME") || "", "insync-accounts.json")
    readonly property bool active: host && host.opened === true
    readonly property var barSource: host && host.shell ? host.shell.popupAnchorItem : null
    readonly property string script: Util.evoshellScript(Quickshell.env("HOME"), shell, "evo-bar-insync popup")
    readonly property string insyncBin: Util.evoshellScript(Quickshell.env("HOME"), shell, "evo-bar-insync")
