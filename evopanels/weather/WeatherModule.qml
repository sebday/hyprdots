...
Item {
    ...
    readonly property int chartHeight: 110
    readonly property int chartLabelPad: 4
    readonly property int chartBottomPad: 18
    ...
    readonly property string metOfficeUrl: String(weather.metOfficeUrl || "")
    ...
    function weatherStyle(code) {
        ...
        return { accent: Theme.accent, glow: Theme.accent, fill: Theme.fillAccentSubtle }
    }
    ...
    function openMetOffice() {
        ...
        Quickshell.execDetached([
            ...
            "open", "brave-weather", root.metOfficeUrl
        ])
    }
