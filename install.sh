...
link "$REPO/.config/hypr/looknfeel.lua" "$HOME/.config/hypr/looknfeel.lua"
...
link "$REPO/.local/bin/flea" "$HOME/.local/bin/flea"
link "$REPO/.local/bin/flea-ui-overlay" "$HOME/.local/bin/flea-ui-overlay"
chmod +x "$REPO/.local/bin/flea" "$REPO/.local/bin/flea-ui-overlay"
"$REPO/.local/bin/flea-ui-overlay"
link "$REPO/.local/share/applications/com.thisisgm.flea.desktop" "$HOME/.local/share/applications/com.thisisgm.flea.desktop"
link "$REPO/.config/environment.d/flea.conf" "$HOME/.config/environment.d/flea.conf"
