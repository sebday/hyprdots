...
# Use fuzzel to select an emoji from the list embedded in this script.
selected_line=$(sed -e '1,/^EMOJI_LIST_START$/d' "$0" | fuzzel --dmenu --width=50 --prompt='Search emoji: ')
