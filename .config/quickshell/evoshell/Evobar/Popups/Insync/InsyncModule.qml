...
Item {
    ...
    readonly property string cacheKey: "evo.bar.popups.insync"
    ...
    readonly property string script: Quickshell.env("HOME") + "/.local/bin/evo-bar-insync popup"
    readonly property string insyncBin: Quickshell.env("HOME") + "/.local/bin/evo-bar-insync"
