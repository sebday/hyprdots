...
Item {
    ...
    readonly property string script: Quickshell.env("HOME") + "/.local/bin/evo-bar-transmission popup"
    readonly property int hintFont: Theme.fontSizeL
    readonly property int titleFont: Theme.fontSize2xl
    readonly property int statFont: Theme.fontSizeXl
    readonly property string transmissionBin: Quickshell.env("HOME") + "/.local/bin/evo-bar-transmission"
