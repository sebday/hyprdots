...
Item {
    ...
    readonly property string script: Quickshell.env("HOME") + "/.local/bin/evo-bar-steam popup"
    readonly property string steamBin: Quickshell.env("HOME") + "/.local/bin/evo-bar-steam"
