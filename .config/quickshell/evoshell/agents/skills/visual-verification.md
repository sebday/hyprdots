...
4. Right-click pins when supported (`Util.pinHoverPopupFromBarIfActive`)
...
```bash
evo-ipc shell summon evo.bar.popups.weather ""
evo-ipc shell hide evo.bar.popups.weather
evo-ipc shell toggle evo.sys.settings ""
```

## Dashboards and overlays

1. `evo-ipc shell toggle evo.panel.player ""` opens and closes the player dashboard
