...
Item {
    ...
    readonly property string demoJsonPath: (shell && shell.shellDir)
        ? shell.shellDir + "/Evopanel/Shopify/demo.json"
        : home + "/.config/quickshell/evoshell/Evopanel/Shopify/demo.json"
    ...
    JsonPollRunner {
        ...
        command: ["bash", root.home + "/.local/bin/evo-panel-shopify", root.storeKey, "30"]
