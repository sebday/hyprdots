...
@keyframes ripple-on-headerbar {
  from {
    background-image: radial-gradient(circle, {{ blue }} 0%, transparent 0%);
  }
  to {
    background-image: radial-gradient(circle, {{ blue }} 100%, transparent 100%);
  }
}
...
iconview,
.view {
  background-color: color-mix(in srgb, {{ bright_foreground }} 4%, transparent);
  color: {{ bright_foreground }};
}

iconview:disabled,
.view:disabled {
  color: color-mix(in srgb, {{ bright_foreground }} 50%, transparent);
}
...
textview border {
  ...
  color: color-mix(in srgb, {{ bright_foreground }} 70%, transparent);
}
...
popover.magnifier > contents, .osd {
  ...
  border-radius: 12px;
  border: none;
  box-shadow: 0 2px 3px -1px rgba(0, 0, 0, 0.15), 0 4px 3px 0 rgba(0, 0, 0, 0.18), 0 1px 6px 0 rgba(0, 0, 0, 0.12), inset 0 1px color-mix(in srgb, {{ bright_foreground }} 10%, transparent);
}
...
entry {
  ...
  background-color: color-mix(in srgb, {{ bright_foreground }} 8%, transparent);
  color: color-mix(in srgb, {{ bright_foreground }} 70%, transparent);
...
entry undershoot.left > undershoot.left {
  ...
  box-shadow: none;
  background: linear-gradient(to right, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.75), transparent 4px);
}
...
entry undershoot.right > undershoot.right {
  ...
  box-shadow: none;
  background: linear-gradient(to left, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.75), transparent 4px);
}
...
entry.error > text > selection {
  background-color: rgba(210, 15, 57, 0.25);
  color: {{ bright_red }};
}
...
entry.warning > text > selection {
  background-color: rgba(223, 142, 29, 0.25);
  color: {{ yellow }};
}
...
entry.success > text > selection {
  background-color: rgba(64, 160, 43, 0.25);
  color: {{ green }};
}
...
.entry-tag {
  ...
  border-radius: 9999px;
  box-shadow: none;
  background-color: color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
  color: {{ bright_foreground }};
}
...
@keyframes needs-attention {
  from {
    background-image: radial-gradient(farthest-side, {{ blue }} 0%, transparent 0%);
  }
  to {
    background-image: radial-gradient(farthest-side, {{ blue }} 95%, transparent);
  }
}
...
infobar.warning > revealer > box button:disabled, popover.touch-selection button:disabled, popover.magnifier button:disabled, headerbar.selection-mode button:disabled:not(.suggested-action):not(.destructive-action) {
  color: color-mix(in srgb, {{ bright_foreground }} 32%, transparent);
}
...
placessidebar list.navigation-sidebar > row button.sidebar-button:checked {
  background-color: color-mix(in srgb, {{ background }} 87%, transparent);
  color: {{ bright_foreground }};
}
...
dnd tab:not(:selected) button.image-button.tab-close-button, notebook > header > tabs > tab:not(:checked):not(:selected) button.small-button, notebook > header menubutton > button.flat {
  color: color-mix(in srgb, {{ background }} 60%, transparent);
}
...
dnd tab:not(:selected) notebook > header button.image-button.tab-close-button:focus:not(:hover):not(:active) menubutton > button.keyboard-activating.flat, notebook > header > tabs > tab:not(:checked):not(:selected) button.small-button:focus:not(:hover):not(:active) menubutton > button.keyboard-activating.flat, notebook > header menubutton > button.flat:focus:not(:hover):not(:active) menubutton > button.keyboard-activating.flat {
  color: color-mix(in srgb, {{ background }} 87%, transparent);
}
...
dnd tab:not(:selected) button.image-button.tab-close-button:disabled, notebook > header > tabs > tab:not(:checked):not(:selected) button.small-button:disabled, notebook > header menubutton > button.flat:disabled {
  color: color-mix(in srgb, {{ background }} 30%, transparent);
}
...
headerbar popover.background button:focus:not(.suggested-action):not(.destructive-action):not(.flat), button:focus {
  outline: 2px solid color-mix(in srgb, {{ blue }} 35%, transparent);
  outline-offset: 0;
}
...
headerbar popover.background button:checked:disabled:not(.suggested-action):not(.destructive-action):not(.flat), button:checked:disabled {
  outline-color: transparent;
  background-color: color-mix(in srgb, {{ blue }} 35%, transparent);
  color: color-mix(in srgb, {{ background }} 38%, transparent);
}

placessidebar list.navigation-sidebar > row button.sidebar-button, calendar > header > button, scrollbar button, notebook > header > tabs > arrow, popover modelbutton, spinbutton > button, splitbutton.flat > button,
...
placessidebar list.navigation-sidebar > row button.sidebar-button:hover, calendar > header > button:hover, scrollbar button:hover, notebook > header > tabs > arrow:hover, popover modelbutton:hover, spinbutton > button:hover, splitbutton.flat > button:hover,
splitbutton.flat > menubutton > button:hover {
  background-color: alpha(currentColor, 0.08);
  color: {{ bright_foreground }};
}

placessidebar list.navigation-sidebar > row button.sidebar-button:active, calendar > header > button:active, scrollbar button:active, notebook > header > tabs > arrow:active, popover modelbutton:active, spinbutton > button:active, splitbutton.flat > button:active,
...
placessidebar list.navigation-sidebar > row button.sidebar-button:disabled, calendar > header > button:disabled, scrollbar button:disabled, notebook > header > tabs > arrow:disabled, popover modelbutton:disabled, spinbutton > button:disabled, splitbutton.flat > button:disabled,
splitbutton.flat > menubutton > button:disabled {
  color: color-mix(in srgb, {{ bright_foreground }} 32%, transparent);
  background-color: transparent;
}

#NautilusPathButton, filechooser #pathbarbox > stack > box > button, window.messagedialog .response-area button, window.dialog.message .dialog-action-area > button, .app-notification button, .toolbar button, dropdown > .linked:not(.vertical) > button:not(:only-child),
combobox > .linked:not(.vertical) > button:not(:only-child), splitbutton.suggested-action > button,
...
#NautilusPathButton:focus:not(:hover):not(:active), filechooser #pathbarbox > stack > box > button:focus:not(:hover):not(:active), window.messagedialog .response-area button:focus:not(:hover):not(:active), window.dialog.message .dialog-action-area > button:focus:not(:hover):not(:active), .app-notification button:focus:not(:hover):not(:active), .toolbar button:focus:not(:hover):not(:active), dropdown > .linked:not(.vertical) > button:focus:not(:hover):not(:active):not(:only-child),
combobox > .linked:not(.vertical) > button:focus:not(:hover):not(:active):not(:only-child), splitbutton.suggested-action > button:focus:not(:hover):not(:active),
...
#NautilusPathButton:hover, filechooser #pathbarbox > stack > box > button:hover, window.messagedialog .response-area button:hover, window.dialog.message .dialog-action-area > button:hover, .app-notification button:hover, .toolbar button:hover, dropdown > .linked:not(.vertical) > button:hover:not(:only-child),
combobox > .linked:not(.vertical) > button:hover:not(:only-child), splitbutton.suggested-action > button:hover,
...
#NautilusPathButton:active, filechooser #pathbarbox > stack > box > button:active, window.messagedialog .response-area button:active, window.dialog.message .dialog-action-area > button:active, .app-notification button:active, .toolbar button:active, dropdown > .linked:not(.vertical) > button:active:not(:only-child),
combobox > .linked:not(.vertical) > button:active:not(:only-child), splitbutton.suggested-action > button:active,
...
#NautilusPathButton:disabled, filechooser #pathbarbox > stack > box > button:disabled, window.messagedialog .response-area button:disabled, window.dialog.message .dialog-action-area > button:disabled, .app-notification button:disabled, .toolbar button:disabled, dropdown > .linked:not(.vertical) > button:disabled:not(:only-child),
combobox > .linked:not(.vertical) > button:disabled:not(:only-child), splitbutton.suggested-action > button:disabled,
...
#NautilusPathButton:checked, filechooser #pathbarbox > stack > box > button:checked, window.messagedialog .response-area button:checked, window.dialog.message .dialog-action-area > button:checked, .app-notification button:checked, .toolbar button:checked, dropdown > .linked:not(.vertical) > button:checked:not(:only-child),
combobox > .linked:not(.vertical) > button:checked:not(:only-child), splitbutton.suggested-action > button:checked,
...
#NautilusPathButton:checked:disabled, filechooser #pathbarbox > stack > box > button:checked:disabled, window.messagedialog .response-area button:checked:disabled, window.dialog.message .dialog-action-area > button:checked:disabled, .app-notification button:checked:disabled, .toolbar button:checked:disabled, dropdown > .linked:not(.vertical) > button:checked:disabled:not(:only-child),
combobox > .linked:not(.vertical) > button:checked:disabled:not(:only-child), splitbutton.suggested-action > button:checked:disabled,
...
.osd button.opaque:focus:focus-visible {
  outline-color: color-mix(in srgb, {{ bright_foreground }} 15%, transparent);
}
...
button.card {
  ...
  background-clip: padding-box;
  font-weight: inherit;
  border: 1px solid color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
...
button.osd:disabled {
  ...
  color: color-mix(in srgb, {{ bright_foreground }} 35%, transparent);
}
...
splitbutton.flat > separator {
  background: color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
}
...
splitbutton.suggested-action > menubutton > button:dir(ltr), splitbutton.destructive-action > menubutton > button:dir(ltr), splitbutton.opaque > menubutton > button:dir(ltr) {
  box-shadow: inset 1px 0 color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
}
...
.app-notification, .toolbar.osd {
  ...
  padding: 6px;
  border-radius: 12px;
  box-shadow: 0 2px 3px -1px rgba(0, 0, 0, 0.05), 0 4px 6px 0 rgba(0, 0, 0, 0.06), 0 1px 10px 0 rgba(0, 0, 0, 0.05), inset 0 1px color-mix(in srgb, {{ bright_foreground }} 10%, transparent);
  background-color: {{ lighter_background }};
  color: {{ bright_foreground }};
  border: none;
}
...
.app-notification:backdrop, .toolbar.osd:backdrop {
  box-shadow: 0 3px 2px -3px rgba(0, 0, 0, 0.2), 0 2px 2px -1px rgba(0, 0, 0, 0.24), 0 1px 3px 0 rgba(0, 0, 0, 0.12), inset 0 1px color-mix(in srgb, {{ bright_foreground }} 10%, transparent);
}
...
headerbar button:checked:hover:not(.suggested-action):not(.destructive-action) {
  box-shadow: inset 0 0 0 1000px color-mix(in srgb, {{ background }} 4%, transparent);
  color: color-mix(in srgb, {{ background }} 87%, transparent);
}
...
headerbar.default-decoration {
  ...
  box-shadow: inset 0 1px color-mix(in srgb, {{ bright_foreground }} 10%, transparent);
  border: none;
  outline: none;
}
...
window.devel headerbar {
  background: {{ background }} cross-fade(10%-gtk-icontheme("system-run-symbolic"), image(transparent)) 90% 0/256px 256px no-repeat, linear-gradient(to right, transparent 65%, color-mix(in srgb, {{ blue }} 10%, transparent)), linear-gradient(to top, #242437 3px, #28283d);
}

window.devel headerbar:backdrop {
  background: {{ background }} cross-fade(10%-gtk-icontheme("system-run-symbolic"), image(transparent)) 90% 0/256px 256px no-repeat, image({{ background }});
...
columnview.view,
treeview.view {
  border-left-color: {{ lighter_background }};
  border-top-color: {{ lighter_background }};
}
...
treeview.view.separator {
  min-height: 5px;
  color: color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
}
...
treeview.view.trough {
  border-bottom: 6px solid color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
  box-shadow: none;
  background-color: transparent;
  background-image: none;
}
...
treeview.view > header > button {
  ...
  border-radius: 0;
  background-clip: border-box;
  border-image: linear-gradient(to bottom, transparent 20%, color-mix(in srgb, {{ bright_foreground }} 12%, transparent) 20%, color-mix(in srgb, {{ bright_foreground }} 12%, transparent) 80%, transparent 80%) 0 1 0 0/0 1px 0 0 stretch;
}
...
treeview.view header.button.dnd {
  ...
  border-width: 1px;
  border-color: color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
  border-radius: 0;
  box-shadow: none;
  background-color: {{ lighter_background }};
  background-clip: border-box;
...
popover > contents {
  ...
  color: {{ bright_foreground }};
  border: none;
  box-shadow: 0 8px 6px -5px rgba(0, 0, 0, 0.2), 0 16px 15px 2px rgba(0, 0, 0, 0.14), 0 6px 18px 5px rgba(0, 0, 0, 0.12), 0 0 0 2px {{ blue }}, 0 0 36px transparent;
}
...
tabbar scrolledwindow.pinned undershoot {
  border: 0 solid color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
}
...
tabbar undershoot.left {
  background: linear-gradient(to right, {{ lighter_background }}, rgba(0, 0, 0, 0) 20px);
}

tabbar undershoot.right {
  background: linear-gradient(to left, {{ lighter_background }}, rgba(0, 0, 0, 0) 20px);
}

tabbar .needs-attention-left undershoot.left {
  background: linear-gradient(to right, alpha({{ blue }}, 0.5), alpha({{ blue }}, 0.3) 1px, alpha({{ blue }}, 0) 20px);
}

tabbar .needs-attention-right undershoot.right {
  background: linear-gradient(to left, alpha({{ blue }}, 0.5), alpha({{ blue }}, 0.3) 1px, alpha({{ blue }}, 0) 20px);
}
...
tabbar tabbox > separator {
  margin: 9px 0;
  min-width: 1px;
  background-color: color-mix(in srgb, {{ background }} 12%, transparent);
...
tabbar tab.needs-attention {
  background-image: radial-gradient(ellipse at bottom, color-mix(in srgb, {{ bright_foreground }} 80%, transparent), alpha({{ blue }}, 0.4) 10%, alpha({{ blue }}, 0) 30%);
}

tabbar tab.needs-attention:hover {
  background-image: image(alpha(currentColor, 0.03)), radial-gradient(ellipse at bottom, color-mix(in srgb, {{ bright_foreground }} 80%, transparent), alpha({{ blue }}, 0.4) 10%, alpha({{ blue }}, 0) 30%);
}
...
tabbar:not(.inline) undershoot.left {
  background: linear-gradient(to right, {{ background }}, rgba(0, 0, 0, 0) 20px);
}

tabbar:not(.inline) undershoot.right {
  background: linear-gradient(to left, {{ background }}, rgba(0, 0, 0, 0) 20px);
}
...
dnd tab {
  ...
  outline: 1px solid color-mix(in srgb, {{ background }} 75%, transparent);
  outline-offset: -1px;
  margin: 24px;
}
...
scrollbar.overlay-indicator:not(.dragging):not(.hovering) button {
  ...
  border-radius: 9999px;
  background-color: color-mix(in srgb, {{ bright_foreground }} 50%, transparent);
  background-clip: padding-box;
  -gtk-icon-source: none;
}

scrollbar.overlay-indicator:not(.dragging):not(.hovering) button:disabled {
  background-color: color-mix(in srgb, {{ bright_foreground }} 32%, transparent);
}
...
switch:focus slider, switch:hover slider, switch:focus:hover slider {
  box-shadow: 0 0 0 6px color-mix(in srgb, {{ bright_foreground }} 60%, transparent), 0 3px 3px -2px transparent, 0 2px 3px -1px transparent, 0 1px 4px 0 transparent;
}
...
check:hover,
radio:hover {
  box-shadow: 0 0 0 6px color-mix(in srgb, {{ bright_foreground }} 4%, transparent);
  background-color: color-mix(in srgb, {{ bright_foreground }} 15%, transparent);
}

check:active,
radio:active {
  box-shadow: 0 0 0 6px color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
  background-color: color-mix(in srgb, {{ bright_foreground }} 20%, transparent);
}
...
radio:indeterminate:hover {
  box-shadow: 0 0 0 6px color-mix(in srgb, {{ blue }} 15%, transparent);
...
radio:indeterminate:active {
  box-shadow: 0 0 0 6px color-mix(in srgb, {{ blue }} 20%, transparent);
  background-color: {{ blue }};
}
...
scale > trough {
  transition: background-color 75ms cubic-bezier(0, 0, 0.2, 1);
  outline: none;
  background-color: color-mix(in srgb, {{ bright_foreground }} 30%, transparent);
}
...
scale > trough > highlight:disabled {
  background-color: {{ background }};
  background-image: image(color-mix(in srgb, {{ bright_foreground }} 32%, transparent));
}
...
scale > trough > slider:hover {
  box-shadow: inset 0 0 0 2px {{ blue }}, 0 0 0 8px color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
}

scale > trough > slider:active {
  box-shadow: inset 0 0 0 4px {{ blue }}, 0 0 0 8px color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
}

scale > trough > slider:disabled {
  box-shadow: inset 0 0 0 2px color-mix(in srgb, {{ bright_foreground }} 32%, transparent);
}
...
scrolledwindow.undershoot-top > undershoot.top {
  ...
  box-shadow: none;
  background: linear-gradient(to bottom, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.75), transparent 4px);
}

scrolledwindow.undershoot-bottom > undershoot.bottom {
  border-radius: 0 0 0px 0px;
  box-shadow: none;
  background: linear-gradient(to top, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.75), transparent 4px);
}
...
list.separators.horizontal > row:not(.separator):not(:last-child) {
  border-left: 1px solid color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
}
...
list.separators:not(.horizontal) > row:not(.separator):not(:last-child) {
  border-bottom: 1px solid color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
}
...
row.entry.error text > selection:focus-within {
  background-color: alpha({{ bright_red }}, 0.2);
}
...
columnview.column-separators > listview > row > cell {
  border-left-color: color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
}
...
paned > separator {
  ...
  border-style: none;
  background-color: transparent;
  background-image: image({{ lighter_background }});
...
paned > separator.wide {
  ...
  min-height: 6px;
  background-color: {{ background }};
  background-image: image({{ lighter_background }}), image({{ lighter_background }});
...
window.csd:backdrop {
  transition: box-shadow 75ms cubic-bezier(0, 0, 0.2, 1);
  box-shadow: 0 2px 3px -1px rgba(0, 0, 0, 0.15), 0 4px 3px 0 rgba(0, 0, 0, 0.18), 0 1px 6px 0 rgba(0, 0, 0, 0.12), 0 0 0 2px {{ lighter_background }}, 0 0 36px transparent;
}
...
window.solid-csd {
  ...
  border-radius: 0;
  background-color: {{ background }};
  border: 1px solid {{ lighter_background }};
}
...
windowcontrols > button.minimize:hover:not(.suggested-action):not(.destructive-action), windowcontrols > button.minimize:active:not(.suggested-action):not(.destructive-action), windowcontrols > button.maximize:hover:not(.suggested-action):not(.destructive-action), windowcontrols > button.maximize:active:not(.suggested-action):not(.destructive-action), windowcontrols > button.close:hover:not(.suggested-action):not(.destructive-action), windowcontrols > button.close:active:not(.suggested-action):not(.destructive-action) {
  color: color-mix(in srgb, {{ bright_foreground }} 60%, transparent);
}
...
shortcut > .keycap {
  ...
  padding-left: 8px;
  padding-right: 8px;
  border: solid 1px color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
  border-radius: 13px;
  box-shadow: inset 0 -2px color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
  background-color: {{ lighter_background }};
  color: {{ bright_foreground }};
  font-size: smaller;
}
...
.nautilus-window tabbar .box:backdrop {
  background-color: transparent;
  box-shadow: none;
}

.nautilus-window tabbox, .nautilus-window tabbox:backdrop {
  transition: none;
  background-color: transparent;
}

.nautilus-window tabbox > tabboxchild > tab {
  color: color-mix(in srgb, {{ bright_foreground }} 70%, transparent);
}

.nautilus-window tabbox > tabboxchild > tab:hover {
  background-color: color-mix(in srgb, {{ bright_foreground }} 4%, transparent);
  color: {{ bright_foreground }};
}

.nautilus-window tabbox > tabboxchild > tab:disabled {
  color: color-mix(in srgb, {{ bright_foreground }} 32%, transparent);
}

.nautilus-window tabbox > tabboxchild > tab:checked, .nautilus-window tabbox > tabboxchild > tab:selected {
  background-color: color-mix(in srgb, {{ bright_foreground }} 4%, transparent);
  color: {{ blue }};
  box-shadow: none;
}

.nautilus-window tabbox > tabboxchild > tab:checked:disabled, .nautilus-window tabbox > tabboxchild > tab:selected:disabled {
  color: color-mix(in srgb, {{ bright_foreground }} 50%, transparent);
}

.nautilus-window tabbox > tabboxchild > tab button.tab-close-button {
  color: {{ bright_foreground }};
}

.nautilus-window tabbox > tabboxchild > tab button.tab-close-button:hover, .nautilus-window tabbox > tabboxchild > tab button.tab-close-button:active {
  color: {{ bright_foreground }};
}

.nautilus-window tabbox > tabboxchild > tab button.tab-close-button:disabled {
  color: {{ bright_foreground }};
}
...
.nautilus-window banner > revealer > widget:hover {
  background-color: {{ lighter_background }};
  border-radius: 9px;
  margin: 9px;
}
...
.nautilus-window banner > revealer > widget button:hover {
  background-color: color-mix(in srgb, {{ blue }} 60%, transparent);
}
...
.display-container #displayitem {
  ...
  font-size: 1.4em;
  border-top: 1px solid color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
}
...
leaflet button.number-button {
  background-color: color-mix(in srgb, {{ bright_foreground }} 10%, transparent);
}
...
.week-header .week-number {
  ...
  color: color-mix(in srgb, {{ bright_foreground }} 30%, transparent);
}
...
.category-tile.card.category-create {
  background: linear-gradient(180deg, {{ magenta }} 0%, #2861c6 100%);
  color: white;
}

.category-tile.card.category-create:hover {
  background: linear-gradient(180deg, shade({{ magenta }}, 1.07) 0%, shade(#2861c6, 1.1) 100%);
  color: white;
}

.category-tile.card.category-create:active {
  background: linear-gradient(180deg, shade({{ magenta }}, 0.95) 0%, shade(#2861c6, 0.95) 100%);
  color: white;
}
...
.category-tile.card.category-develop:hover {
  background-color: shade({{ muted }}, 1.2);
  color: white;
}

.category-tile.card.category-develop:active {
  background-color: shade({{ muted }}, 0.95);
  color: white;
}

.category-tile.card.category-learn {
  background: linear-gradient(180deg, {{ green }} 30%, #27a66c 100%);
  color: white;
}

.category-tile.card.category-learn:hover {
  background: linear-gradient(180deg, shade({{ green }}, 1.06) 30%, shade(#27a66c, 1.06) 100%);
  color: white;
}

.category-tile.card.category-learn:active {
  background: linear-gradient(180deg, shade({{ green }}, 0.95) 30%, shade(#27a66c, 0.95) 100%);
  color: white;
}

.category-tile.card.category-play {
  background: linear-gradient(75deg, {{ yellow }} 0%, {{ magenta }} 50%, {{ magenta }} 100%);
  color: {{ muted }};
}

.category-tile.card.category-play:hover {
  background: linear-gradient(75deg, shade({{ yellow }}, 1.07) 0%, shade({{ magenta }}, 1.07) 50%, shade({{ magenta }}, 1.07) 100%);
  color: {{ muted }};
}

.category-tile.card.category-play:active {
  background: linear-gradient(75deg, shade({{ yellow }}, 0.97) 0%, shade({{ magenta }}, 0.95) 50%, shade({{ magenta }}, 1.07) 100%);
  color: {{ muted }};
}

.category-tile.card.category-socialize {
  background: linear-gradient(90deg, {{ magenta }} 0%, {{ orange }} 100%);
  color: color-mix(in srgb, {{ bright_foreground }} 70%, transparent);
}

.category-tile.card.category-socialize:hover {
  background: linear-gradient(90deg, shade({{ magenta }}, 1.08) 0%, shade({{ orange }}, 1.08) 100%);
}

.category-tile.card.category-socialize:active {
  background: linear-gradient(90deg, shade({{ magenta }}, 0.95) 0%, shade({{ orange }}, 0.95) 100%);
}
...
.category-tile.card.category-work {
  ...
  background-image: linear-gradient(color-mix(in srgb, {{ bright_foreground }} 12%, transparent) 1px, transparent 1px), linear-gradient(90deg, color-mix(in srgb, {{ bright_foreground }} 12%, transparent) 1px, transparent 1px);
...
.install-progress {
  background-image: linear-gradient(to top, {{ blue }} 2px, alpha({{ blue }}, 0) 2px);
  background-repeat: no-repeat;
...
.review-row .vote-buttons button:not(:first-child) {
  border-image: linear-gradient(to top, color-mix(in srgb, {{ bright_foreground }} 12%, transparent), color-mix(in srgb, {{ bright_foreground }} 12%, transparent)) 0 0 0 1/5px 0 5px 1px;
}
...
window > contents > leaflet > box > stack.background {
  background-color: transparent;
  background-image: linear-gradient(to bottom, transparent, transparent 46px, {{ background }} 46px, {{ background }});
}

@define-color weather_temp_chart_fill_color rgba(223, 142, 29, 0.5);
@define-color weather_temp_chart_stroke_color #b27117;
...
scrolledwindow.inline undershoot.top {
  box-shadow: inset 0 1px color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
}
...
.astro .clock-time {
  color: {{ orange }};
  background-color: alpha(#fe640b, 0.25);
}
...
.style-variant button.toggle:hover > stylevariantpreview > .wallpaper {
  outline-color: color-mix(in srgb, {{ bright_foreground }} 4%, transparent);
}

.style-variant button.toggle:active > stylevariantpreview > .wallpaper {
  outline-color: color-mix(in srgb, {{ bright_foreground }} 30%, transparent);
}
...
toast {
  ...
  border-spacing: 6px;
  padding: 6px;
  box-shadow: 0 2px 3px -1px rgba(0, 0, 0, 0.1), 0 4px 6px 0 rgba(0, 0, 0, 0.12), 0 1px 10px 0 rgba(0, 0, 0, 0.1), inset 0 1px color-mix(in srgb, {{ bright_foreground }} 10%, transparent);
  background-color: {{ lighter_background }};
  color: {{ bright_foreground }};
  border: none;
}
...
overlay-split-view > dimming {
  background-color: color-mix(in srgb, {{ background }} 20%, transparent);
  background-image: none;
}
...
overlay-split-view > shadow.left {
  background-image: linear-gradient(to right, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.7), alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.14) 40px, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0) 56px), linear-gradient(to right, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.4), alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.14) 7px, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0) 24px);
}
...
overlay-split-view > shadow.right {
  background-image: linear-gradient(to left, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.7), alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.14) 40px, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0) 56px), linear-gradient(to left, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.4), alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.14) 7px, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0) 24px);
}
...
overlay-split-view > shadow.up {
  background-image: linear-gradient(to bottom, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.7), alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.14) 40px, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0) 56px), linear-gradient(to bottom, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.4), alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.14) 7px, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0) 24px);
}
...
overlay-split-view > shadow.down {
  background-image: linear-gradient(to top, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.7), alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.14) 40px, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0) 56px), linear-gradient(to top, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.4), alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0.14) 7px, alpha(color-mix(in srgb, {{ background }} 20%, transparent), 0) 24px);
}
...
.sidebar-pane navigation-view-page stack > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) button, placessidebar > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) button, .nautilus-window placessidebar scrollbar.overlay-indicator:not(.dragging):not(.hovering) button, leaflet.unfolded > box > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) button, leaflet.unfolded .contacts-contact-list > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) button {
  background-color: color-mix(in srgb, {{ background }} 38%, transparent);
}
...
.sidebar-pane navigation-view-page stack > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) button:disabled, placessidebar > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) button:disabled, .nautilus-window placessidebar scrollbar.overlay-indicator:not(.dragging):not(.hovering) button:disabled, leaflet.unfolded > box > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) button:disabled, leaflet.unfolded .contacts-contact-list > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) button:disabled {
  background-color: color-mix(in srgb, {{ background }} 30%, transparent);
}
...
placessidebar list.navigation-sidebar, .nautilus-window placessidebar > scrolledwindow > viewport > .navigation-sidebar, leaflet.unfolded .contacts-contact-list > scrolledwindow > viewport > .navigation-sidebar, .sidebar-pane toolbarview > stack > box > widget > widget > scrolledwindow > .navigation-sidebar {
  padding: 6px 0 6px 6px;
  background: none;
  color: color-mix(in srgb, {{ bright_foreground }} 70%, transparent);
}

placessidebar list.navigation-sidebar > separator, .nautilus-window placessidebar > scrolledwindow > viewport > .navigation-sidebar > separator, leaflet.unfolded .contacts-contact-list > scrolledwindow > viewport > .navigation-sidebar > separator, .sidebar-pane toolbarview > stack > box > widget > widget > scrolledwindow > .navigation-sidebar > separator {
  background-color: color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
  margin: 10px 15px;
}

placessidebar list.navigation-sidebar > row, .nautilus-window placessidebar > scrolledwindow > viewport > .navigation-sidebar > row, leaflet.unfolded .contacts-contact-list > scrolledwindow > viewport > .navigation-sidebar > row, .sidebar-pane toolbarview > stack > box > widget > widget > scrolledwindow > .navigation-sidebar > row {
  color: color-mix(in srgb, {{ background }} 60%, transparent);
  border-radius: 9px;
  color: {{ bright_foreground }};
  padding: 6px 0;
...
placessidebar list.navigation-sidebar > row:selected, .nautilus-window placessidebar > scrolledwindow > viewport > .navigation-sidebar > row:selected, leaflet.unfolded .contacts-contact-list > scrolledwindow > viewport > .navigation-sidebar > row:selected, .sidebar-pane toolbarview > stack > box > widget > widget > scrolledwindow > .navigation-sidebar > row:selected {
...
placessidebar list.navigation-sidebar > row:selected:hover, .nautilus-window placessidebar > scrolledwindow > viewport > .navigation-sidebar > row:selected:hover, leaflet.unfolded .contacts-contact-list > scrolledwindow > viewport > .navigation-sidebar > row:selected:hover, .sidebar-pane toolbarview > stack > box > widget > widget > scrolledwindow > .navigation-sidebar > row:selected:hover, placessidebar list.navigation-sidebar > row:selected:focus, .nautilus-window placessidebar > scrolledwindow > viewport > .navigation-sidebar > row:selected:focus, leaflet.unfolded .contacts-contact-list > scrolledwindow > viewport > .navigation-sidebar > row:selected:focus, .sidebar-pane toolbarview > stack > box > widget > widget > scrolledwindow > .navigation-sidebar > row:selected:focus {
...
.sidebar-pane navigation-view-page stack > scrolledwindow > scrollbar.top, filechooser paned > box scrolledwindow scrollbar.top, placessidebar > scrolledwindow > scrollbar.top, .nautilus-window placessidebar scrollbar.top, .nautilus-window .nautilus-grid-view scrolledwindow scrollbar.top,
...
.sidebar-pane navigation-view-page stack > scrolledwindow > scrollbar.bottom, filechooser paned > box scrolledwindow scrollbar.bottom, placessidebar > scrolledwindow > scrollbar.bottom, .nautilus-window placessidebar scrollbar.bottom, .nautilus-window .nautilus-grid-view scrolledwindow scrollbar.bottom,
...
.sidebar-pane navigation-view-page stack > scrolledwindow > scrollbar.left, filechooser paned > box scrolledwindow scrollbar.left, placessidebar > scrolledwindow > scrollbar.left, .nautilus-window placessidebar scrollbar.left, .nautilus-window .nautilus-grid-view scrolledwindow scrollbar.left,
...
.sidebar-pane navigation-view-page stack > scrolledwindow > scrollbar.right, filechooser paned > box scrolledwindow scrollbar.right, placessidebar > scrolledwindow > scrollbar.right, .nautilus-window placessidebar scrollbar.right, .nautilus-window .nautilus-grid-view scrolledwindow scrollbar.right,
...
.sidebar-pane .sidebar > scrolledwindow > scrollbar > range > trough > slider,
.sidebar-pane toolbarview > scrolledwindow > scrollbar > range > trough > slider,
.sidebar-pane navigation-view-page stack > scrolledwindow > scrollbar > range > trough > slider, filechooser paned > box scrolledwindow scrollbar > range > trough > slider, placessidebar > scrolledwindow > scrollbar > range > trough > slider, .nautilus-window placessidebar scrollbar > range > trough > slider, .nautilus-window .nautilus-grid-view scrolledwindow scrollbar > range > trough > slider,
.nautilus-window .nautilus-list-view scrolledwindow scrollbar > range > trough > slider, leaflet.unfolded > box > scrolledwindow > scrollbar > range > trough > slider, leaflet.unfolded .contacts-contact-list > scrolledwindow > scrollbar > range > trough > slider, .sidebar-pane toolbarview > stack > box > widget > widget > scrolledwindow > scrollbar > range > trough > slider {
  border: 4px solid transparent;
}
...
.sidebar-pane navigation-view-page stack > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering), filechooser paned > box scrolledwindow scrollbar.overlay-indicator:not(.dragging):not(.hovering), placessidebar > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering), .nautilus-window placessidebar scrollbar.overlay-indicator:not(.dragging):not(.hovering), .nautilus-window .nautilus-grid-view scrolledwindow scrollbar.overlay-indicator:not(.dragging):not(.hovering),
...
.sidebar-pane .sidebar > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) > range > trough > slider,
.sidebar-pane toolbarview > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) > range > trough > slider,
.sidebar-pane navigation-view-page stack > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) > range > trough > slider, filechooser paned > box scrolledwindow scrollbar.overlay-indicator:not(.dragging):not(.hovering) > range > trough > slider, placessidebar > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) > range > trough > slider, .nautilus-window placessidebar scrollbar.overlay-indicator:not(.dragging):not(.hovering) > range > trough > slider, .nautilus-window .nautilus-grid-view scrolledwindow scrollbar.overlay-indicator:not(.dragging):not(.hovering) > range > trough > slider,
.nautilus-window .nautilus-list-view scrolledwindow scrollbar.overlay-indicator:not(.dragging):not(.hovering) > range > trough > slider, leaflet.unfolded > box > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) > range > trough > slider, leaflet.unfolded .contacts-contact-list > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) > range > trough > slider {
  border: none;
  margin: 1px;
}
...
.sidebar-pane .sidebar > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) button,
.sidebar-pane toolbarview > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) button,
.sidebar-pane navigation-view-page stack > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) button, filechooser paned > box scrolledwindow scrollbar.overlay-indicator:not(.dragging):not(.hovering) button, placessidebar > scrolledwindow > scrollbar.overlay-indicator:not(.dragging):not(.hovering) button, .nautilus-window placessidebar scrollbar.overlay-indicator:not(.dragging):not(.hovering) button, .nautilus-window .nautilus-grid-view scrolledwindow scrollbar.overlay-indicator:not(.dragging):not(.hovering) button,
...
.sidebar-pane navigation-view-page stack > scrolledwindow > scrollbar.overlay-indicator.dragging, filechooser paned > box scrolledwindow scrollbar.overlay-indicator.dragging, placessidebar > scrolledwindow > scrollbar.overlay-indicator.dragging, .nautilus-window placessidebar scrollbar.overlay-indicator.dragging, .nautilus-window .nautilus-grid-view scrolledwindow scrollbar.overlay-indicator.dragging,
...
.sidebar-pane navigation-view-page stack > scrolledwindow > scrollbar.overlay-indicator.hovering, filechooser paned > box scrolledwindow scrollbar.overlay-indicator.hovering, placessidebar > scrolledwindow > scrollbar.overlay-indicator.hovering, .nautilus-window placessidebar scrollbar.overlay-indicator.hovering, .nautilus-window .nautilus-grid-view scrolledwindow scrollbar.overlay-indicator.hovering,
...
panelthemeselector checkbutton {
  ...
  background-clip: content-box;
  border-radius: 9999px;
  box-shadow: inset 0 0 0 1px color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
}
...
panelthemeselector checkbutton.follow {
  background-image: linear-gradient(to bottom right, {{ bright_foreground }} 50%, {{ lighter_background }} 50%);
}
...
themeswitcher checkbutton.system {
  background: linear-gradient(-45deg, {{ background }} 50%, {{ bright_foreground }} 50%);
}
...
@define-color theme_fg_color {{ bright_foreground }};
/* text color for entries, views and content in general */
@define-color theme_text_color {{ bright_foreground }};
...
@define-color theme_selected_fg_color color-mix(in srgb, {{ background }} 87%, transparent);
/* base background color of insensitive widgets */
@define-color insensitive_bg_color {{ background }};
/* text foreground color of insensitive widgets */
@define-color insensitive_fg_color color-mix(in srgb, {{ bright_foreground }} 50%, transparent);
/* insensitive text widgets and the like base background color */
@define-color insensitive_base_color {{ lighter_background }};
/* widget text/foreground color on backdrop windows */
@define-color theme_unfocused_fg_color {{ bright_foreground }};
/* text color for entries, views and content in general on backdrop windows */
@define-color theme_unfocused_text_color {{ bright_foreground }};
...
@define-color theme_unfocused_selected_fg_color color-mix(in srgb, {{ background }} 87%, transparent);
/* insensitive color on backdrop windows */
@define-color unfocused_insensitive_color color-mix(in srgb, {{ bright_foreground }} 50%, transparent);
/* widgets main borders color */
@define-color borders color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
/* widgets main borders color on backdrop windows */
@define-color unfocused_borders color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
...
@define-color wm_focused_title {{ bright_foreground }};
@define-color wm_unfocused_title color-mix(in srgb, {{ bright_foreground }} 70%, transparent);
@define-color wm_highlight color-mix(in srgb, {{ bright_foreground }} 10%, transparent);
@define-color wm_border #0a0a0e;
@define-color wm_focused_bg {{ background }};
@define-color wm_unfocused_bg {{ background }};
@define-color wm_button_icon {{ bright_foreground }};
@define-color wm_button_focused_bg {{ lighter_background }};
@define-color wm_button_unfocused_bg {{ lighter_background }};
@define-color wm_button_hover_fg color-mix(in srgb, {{ background }} 87%, transparent);
@define-color wm_button_active_fg color-mix(in srgb, {{ background }} 87%, transparent);
@define-color wm_button_hover_bg {{ bright_foreground }};
@define-color wm_button_active_bg #e7eaf0;
/* FIXME this is really an API */
@define-color content_view_bg {{ lighter_background }};
@define-color placeholder_text_color #b6b8c0;
/* Very contrasty background for text views (@theme_text_color foreground) */
@define-color text_view_bg {{ lighter_background }};
@define-color budgie_tasklist_indicator_color rgba(121, 122, 133, 0.7);
@define-color budgie_tasklist_indicator_color_active {{ blue }};
...
@define-color accent_fg_color color-mix(in srgb, {{ background }} 87%, transparent);
@define-color accent_color {{ blue }};
@define-color destructive_bg_color {{ bright_red }};
...
@define-color warning_fg_color {{ bright_foreground }};
@define-color warning_color {{ yellow }};
@define-color error_bg_color {{ bright_red }};
@define-color error_fg_color {{ bright_foreground }};
@define-color error_color {{ bright_red }};
...
@define-color headerbar_border_color color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
@define-color headerbar_backdrop_color {{ background }};
@define-color headerbar_shade_color color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
@define-color card_bg_color {{ lighter_background }};
@define-color card_fg_color {{ bright_foreground }};
@define-color card_shade_color color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
...
@define-color shade_color color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
@define-color scrollbar_outline_color color-mix(in srgb, {{ bright_foreground }} 12%, transparent);
