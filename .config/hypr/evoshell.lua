...
hl.layer_rule({ match = { namespace = "^(evo-menu|evo-panel|evo-panel-scrim|evo-background|evo-calendar|evo-stats|evo-cursor|evo-weather|evo-network|evo-library|evo-theme|evo-wallpaper|evo-screenshot|evo-clipboard|evo-notifications|evo-bar-tray-menu)$" }, no_anim = true, animation = "none" })
