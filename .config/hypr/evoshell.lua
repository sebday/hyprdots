...
hl.layer_rule({ match = { namespace = "^(evo-menu|evo-panel|evo-panel-scrim|evo-wallpaper|evo-wallpaper-picker|evo-calendar|evo-stats-diy|evo-stats-tgs|evo-cursor|evo-weather|evo-network|bar-volume|bar-media|evo-github|evo-system|evo-stocks|evo-cloudflare|evo-transmission|evo-transmission-add|evo-library|evo-theme|evo-clipboard|evo-notifications|evo-bar-tray-menu)$" }, no_anim = true, animation = "none" })
