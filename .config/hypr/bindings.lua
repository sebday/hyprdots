...
-- Wallpaper
bindd("SUPER + comma", "Previous Wallpaper", hl.dsp.exec_cmd(shell_ipc .. " background prev"))
bindd("SUPER + period", "Next Wallpaper", hl.dsp.exec_cmd(shell_ipc .. " background next"))
