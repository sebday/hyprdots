...
check_present 'wrappedDelta' "${root}/evosys/themes/CarouselOverlay.qml"
check_present 'ringRadiusX' "${root}/evosys/themes/CarouselOverlay.qml"
check_present 'cycle_theme' "${root}/bin/evo-theme"
...
check_present 'themes_ensure_hypr_theme_lua' "${root}/bin/evo-theme-lib"
check_present 'hypr-border-accent' "${root}/bin/evo-theme-lib"
check_present 'evoshell: hypr-border-accent' "${root}/hypr/theme.lua"
...
check_absent 'hyprshot' "${root}/bin/evo-screenshot"
...
check_absent 'SettingsWidget' "${root}/evobar/widgets/qmldir"
check_present 'evo\.sys\.media\.audio' "${root}/pluginManifest.js"
check_present 'evo\.panels\.workspaces' "${root}/pluginManifest.js"
check_present 'MonitorLayoutPicker' "${root}/evopanels/workspaces/WorkspacesModule.qml"
...
check_present 'looksTabScroll' "${root}/evosys/settings/SettingsModule.qml"
check_present 'SettingsTabBar' "${root}/commons/qmldir"
check_present 'displaysTabScroll' "${root}/evosys/settings/SettingsModule.qml"
