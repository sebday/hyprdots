# Generated by Powerlevel10k configuration wizard on 2025-06-20 at 18:44 BST.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%F{#ff757f}%n@%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%F{#c3e88d}%n@%m'
