...
hl.layer_rule({
	match = {
		namespace = "^(evo-sys-menu|evo-side|evo-side-scrim|evo-sys-settings|evo-sys-wallpaper|evo-sys-wallpaper-picker|evo-panels-[a-z0-9-]+|evo-sys-themes|evo-side-clipboard|evo-sys-notifications|evo-bar-tray-menu)$",
	},
	no_anim = true,
	animation = "none",
})
