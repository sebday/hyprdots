#!/bin/bash
# Generate Neovim theme from colors.toml (Modular palette, no Catppuccin dep)
# Usage: themes-generate-neovim.sh <theme_dir>
...
# Read colors (same mapping as themes-generate-vscode.sh)
